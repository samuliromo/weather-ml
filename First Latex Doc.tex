...
\begin{document}
  ...
  \subsection{How does it Work}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.7\linewidth]{Visualization-of-a-traditional-fully-connected-neural-network-Stanford-University.png}
  ...
  \subsection{How does it Work}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\linewidth]{Recurrent.jpeg}
